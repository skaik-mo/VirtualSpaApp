...
private extension OrdersAcceptedViewController {
    ...
    func setUpView() {
        ...
        self.tableView.emptyTitle = Strings.ORDERS_EMPTY_ACCEPTED_TITLE
        self.tableView.cell = AcceptedTableViewCell.self
        self.tableView.rowHeight = 65
    }

    func fetchData() {
        self.tableView.resetTableView(request: .GetBusinessAcceptedReservations)
    }
